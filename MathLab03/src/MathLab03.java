...
class Rational
{
	...
	public void multiply(Rational r1, Rational r2)
	{
		...
		firstNum = (r1.firstNum * r2.firstNum);
		firstDen = (r1.firstDen * r2.firstDen);
		reduce();
	}
	...
	public void divide(Rational r1, Rational r2)
	{
		...
		firstNum = r1.firstNum * r2.firstDen;
		firstDen = r1.firstDen * r2.firstNum;
		reduce();
	}
	...
	public void add(Rational r1, Rational r2)
	{
		...
		firstNum = (r1.firstNum * r2.firstDen) + (r2.firstNum * r1.firstDen);
		firstDen = (r1.firstDen * r2.firstDen);
		reduce();
	}
